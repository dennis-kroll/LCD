...
typedef struct WINDOW1_CONTROL_BLOCK_STRUCT
{
    ...
    GX_TEXT_BUTTON window1_button_1;
    GX_TEXT_BUTTON window1_button_2;
    GX_TEXT_BUTTON window1_button_3;
    GX_TEXT_BUTTON window1_button_4;
    GX_TEXT_BUTTON window1_button_5;
    GX_TEXT_BUTTON window1_button_6;
    GX_TEXT_BUTTON window1_button_7;
    GX_TEXT_BUTTON window1_button_8;
    GX_TEXT_BUTTON window1_button_9;
    GX_TEXT_BUTTON window1_button_10;
    GX_TEXT_BUTTON window1_button_11;
    GX_TEXT_BUTTON window1_button_10_1;
